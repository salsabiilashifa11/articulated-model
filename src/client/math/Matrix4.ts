...
class Matrix4 {
    ...
    multiplyVector(v: Vector4): Vector4 {
        const ret = new Vector4();
        const te = this.elements;

        ret.x = te[0] * v.x + te[1] * v.y + te[2] * v.z + te[3] * v.w;
        ret.y = te[4] * v.x + te[5] * v.y + te[6] * v.z + te[7] * v.w;
        ret.z = te[8] * v.x + te[9] * v.y + te[10] * v.z + te[11] * v.w;
        ret.w = te[12] * v.x + te[13] * v.y + te[14] * v.z + te[15] * v.w;
    ...
    /* Add translation nanti dicheck lagi */
    ...
    /* Add rotation nanti dicheck lagi */
    ...
    transitiveTransform(m: Matrix4) {
        ...
        return new Matrix4().fromArray(tmp);
    }
}
